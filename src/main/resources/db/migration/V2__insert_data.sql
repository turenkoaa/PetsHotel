...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `request` (`request_id`, `start_date`, `end_date`, `status`, `user_user_id`, `pet_pet_id`) VALUES (1, '2018-05-12', '2018-05-25', DEFAULT, 1, 1);
INSERT INTO `request` (`request_id`, `start_date`, `end_date`, `status`, `user_user_id`, `pet_pet_id`) VALUES (2, '2018-06-1', '2018-06-5', DEFAULT, 2, 3);
INSERT INTO `request` (`request_id`, `start_date`, `end_date`, `status`, `user_user_id`, `pet_pet_id`) VALUES (3, '2016-06-1', '2016-07-1', 'anulled', 5, 4);
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `response` (`response_id`, `status`, `details`, `request_request_id`, `user_user_id`) VALUES (1, DEFAULT, NULL, 1, 4);
