...
import com.aaturenko.pethotel.old.dao.mapper.ResponseMapper;
...
public class Response extends Entity {
    ...
    private ValidUpdateResponseStatusStrategy statusStrategy = new ValidUpdateResponseStatusStrategy();
    ...
    public class ValidUpdateResponseStatusStrategy {
        public void reject() {
            request().annuled();
